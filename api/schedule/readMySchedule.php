...
// query schedules
$stmt = $schedule->readMySchedule($EmployeeID);
$num = $stmt->rowCount();
  
// check if more than 0 record found
if($num>0){

    //creating an array of schedule dates
    $schedule_arr = array();
    ...
    // tell the user no schedules found
    echo json_encode(
        array("message" => "No Schedule for this employee found.")
    );
}
?>